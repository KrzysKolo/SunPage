...
type ColorType = 'primary800' | 'primary700' | 'primary600' | 'primary200' | 'primary100' | 'primary50'| 'grey900' | 'grey800'| 'grey700' | 'grey600' | 'grey500' | 'grey200' | 'grey100' | 'grey50' | 'white' | 'beige' ;
